...
export default function VideoRow({
  ...
  return (
    ...
    >
      ...
      {/* Number */}
      <span className="display text-[22px] sm:text-[28px] text-[var(--ocean)] leading-none shrink-0 w-[28px] sm:w-[40px] mt-0.5">
        {video.num}
      </span>
      ...
      {/* Play indicator (right side, appears on hover — desktop only) */}
